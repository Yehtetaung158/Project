...
const SheetOverlay = React.forwardRef(({ className,onOverlay, ...props }, ref) => (
...
const SheetContent = React.forwardRef(({ side = "right", className, children,onClose,onOverlay, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay onOverlay={onOverlay}/>
